...
testWidgets('ExpansionTileItem displays trailing animation with custom animation and test the animation scale',
    (WidgetTester tester) async {
  // Build the widget
  await tester.pumpWidget(MaterialApp(
    home: Scaffold(
  ...
  final initialTransform = tester.widget<Transform>(find.byType(Transform).first );
  ...
  final currentTransform = tester.widget<Transform>(find.byType(Transform).first);
...
void edgeCaseTests(){
  testWidgets('ExpansionTileItem displays title and expands with empty children',
      (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(const MaterialApp(
      home: Scaffold(
